...
<body class="wrapper">
    <header>
        ...
        <div class="right">
            <ul>
                <li><a href="<%=request.getContextPath()%>/home" class="menu">Home</a>         
        ...
        <form action="<%=request.getContextPath()%>/insertBook" method="post" enctype="multipart/form-data" id="data_upload_form">
            ...
            <div class="content_body add_book_content">
                ...
                <div class="content_right">
                    ...
                    <input type="hidden" id="bookId" name="bookId" value="${bookInfo.bookId}"> <input type="hidden" name="userId" class="get_userId" value="${userId}">
                </div>
            </div>
